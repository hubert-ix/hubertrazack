  ...
  <section class="testimonials">
    <div class="container">
      <Carousel>
        ...
        <Testimonial authorName="Maher El Hares" authorTitle="Creator. Producer. Whatever." text="'Holy shit. Ugh it's soo good - jeez - friggin rights he nailed it!'. This was my reaction when first hearing Hubert's music for our movie. It's so nice to work with someone who actually understands the assignment." />
  ...
  <section class="alt about" id="about">
    <div class="container flex">
      <div class="left">
        ...
        <p>Originally trained in applied mathematics in France, Hubert later completed a post-graduate music composition course with honours at Humber College. His teachers included renowned composer Kevin Lau and orchestrator Rebecca Pellet. He is a member of the Screen Composers Guild of Canada and resides in Toronto with his partner Lourdes and his dog Philip (who approves this message).</p>
      </div>
      <div class="right">
